...
class ParkingLotInfoFragment : BaseFragment() {
    ...
    override fun onCreateView(
        ...
        _binding = FragmentParkingLotInfoBinding.inflate(layoutInflater, container, false)
        return binding.root
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment ParkingLotInfoFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ParkingLotInfoFragment().apply {
