...
class ParkingOwnerInfoFragment : BaseFragment() {
    ...
    override fun onCreateView(
        ...
        _binding = FragmentParkingOwnerInfoBinding.inflate(layoutInflater, container, false)
        return binding.root
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment ParkingOwnerInfoFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ParkingOwnerInfoFragment().apply {
